...
import { ArrowDown, ArrowUp, ArrowUpDown, Search, X, Boxes, RotateCcw } from "lucide-react";
              ...
              <TableRow key={headerGroup.id} className="hover:bg-transparent">
                {headerGroup.headers.map(header => {
                  ...
                  return (
                    <TableHead
                      key={header.id}
                      className="text-xs font-semibold py-2.5 text-muted-foreground"
                    >
                  ...
                  <React.Fragment key={row.id}>
                    <TableRow
                      ...
                      className={`transition-colors ${
                        expanded ? "border-b-0 bg-primary/5" : "hover:bg-muted/40"
                      }`}
                    >
