      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
        ...
        <div className="bg-background/90 p-2.5 rounded-lg border border-border/60 flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between mt-1 gap-1">
            <span
              className="font-mono font-semibold text-xs truncate text-foreground"
              title={targetEndpoint}
            >
              {targetEndpoint}
            </span>
            <Button
        ...
        <div className="bg-background/90 p-2.5 rounded-lg border border-border/60 flex flex-col justify-between">
          ...
          <span
            className="font-mono font-semibold text-xs truncate mt-1 text-foreground"
        ...
        <div className="bg-background/90 p-2.5 rounded-lg border border-border/60 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-1.5 mt-1 truncate text-[11px]">
            {interceptInfo.mount_point ? (
              <Badge
                variant="outline"
                className="text-[10px] px-1.5 py-0 h-4 border-emerald-500/50 text-emerald-600 dark:text-emerald-400 font-semibold"
              >
                Mounted
              </Badge>
            ) : (
