...
import { AlertCircle, ChevronDown, ChevronRight, Info, Radio, Layers, Boxes } from "lucide-react";
          ...
          <div className="flex items-center gap-1.5 font-medium">
            ...
            <span
              className={`truncate text-xs font-semibold ${
                isAttached ? "text-primary cursor-pointer hover:underline" : "text-foreground"
              }`}
              onClick={() => {
                if (isAttached) {
    ...
    columnHelper.accessor("workload_resource_type", {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge
            variant="outline"
            className="bg-primary/5 text-primary border-primary/20 text-[11px] font-mono"
          >
      ...
      cell: ({ row }) => {
        ...
        if (workload.not_interceptable_reason) {
          return (
            <Badge
              variant="outline"
              className="border-border bg-muted/60 text-muted-foreground gap-1 max-w-37.5 truncate cursor-help text-xs"
        ...
        return (
          <Badge
            variant="outline"
            className="border-border/80 text-muted-foreground text-xs font-normal"
          >
            Ready
          </Badge>
        );
        ...
        return (
          <div className="flex items-center gap-1.5">
            <Button
              ...
              title={
                isNonInterceptable ? workload.not_interceptable_reason : "Intercept this workload"
              }
            >
            ...
            <Button
              ...
              disabled={isNonInterceptable}
              title={
                isNonInterceptable ? workload.not_interceptable_reason : "Replace this workload"
              }
            >
